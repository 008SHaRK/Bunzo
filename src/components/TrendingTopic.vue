...
export default {
  ...
  data() {
    return {
      ...
      gap: 20,
      items: [
        { title: "Design", image: "src/assets/img/1-2.jpg" },
        { title: "Drupal", image: "src/assets/img/2-1.jpg" },
        { title: "Javascript", image: "src/assets/img/14-1.jpg" },
        { title: "Joomla", image: "src/assets/img/13.jpg" },
        { title: "Magento", image: "src/assets/img/16.jpg" },
        { title: "WordPress", image: "src/assets/img/6-1.jpg" },
      ],
    };
  },
  methods: {
